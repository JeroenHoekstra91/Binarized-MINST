...
_TRAIN_IMAGES_FILENAME = "ds-train-images.txt"
_TRAIN_LABELS_FILENAME = "ds-train-labels.txt"
_TEST_IMAGES_FILENAME  = "ds-test-images.txt"
_TEST_LABELS_FILENAME  = "ds-test-labels.txt"

_TRAIN_EXAMPLES = 60000
_TEST_EXAMPLES  = 10000

class LabeledDownscaledBinarizedMnist(tfds.core.GeneratorBasedBuilder):
  """DatasetBuilder for labeled_downscaled_binarized_mnist dataset."""
  ...
  def _info(self) -> tfds.core.DatasetInfo:
    ...
    return tfds.core.DatasetInfo(
        ...
        features    = tfds.features.FeaturesDict({
            ...
            'image': tfds.features.Image(shape=(14, 14, 1)),
  ...
  def _generate_examples(self, num_examples, images_path, label_path):
    """Generate Labeled Downscaled Binarized MNIST examples as dicts.
